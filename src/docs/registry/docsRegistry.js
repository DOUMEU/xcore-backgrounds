// NOTE: only SplitText has verified content right now. The rest of the
// text-animations doc files were created as empty stubs and will throw an
// unresolved-import build error if re-enabled before their content (and
// import path, which currently has an incorrect "Docs" suffix) is filled in.
