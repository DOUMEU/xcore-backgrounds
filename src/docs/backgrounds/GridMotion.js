...
import componentCode from "../../components/backgrounds/GridMotion.jsx?raw";
import cssCode from "../../components/backgrounds/GridMotion.css?raw";

const installCommands = {
  pnpm: "pnpm dlx shadcn@latest add @react-bits/GridMotion-JS-CSS",
  npm: "npx shadcn@latest add @react-bits/GridMotion-JS-CSS",
  yarn: "yarn dlx shadcn@latest add @react-bits/GridMotion-JS-CSS",
  bun: "bunx shadcn@latest add @react-bits/GridMotion-JS-CSS",
};
