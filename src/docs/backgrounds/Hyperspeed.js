...
import componentCode from "../../components/backgrounds/Hyperspeed.jsx?raw";
import cssCode from "../../components/backgrounds/Hyperspeed.css?raw";

const installCommands = {
  pnpm: "pnpm dlx shadcn@latest add @react-bits/Hyperspeed-JS-CSS",
  npm: "npx shadcn@latest add @react-bits/Hyperspeed-JS-CSS",
  yarn: "yarn dlx shadcn@latest add @react-bits/Hyperspeed-JS-CSS",
  bun: "bunx shadcn@latest add @react-bits/Hyperspeed-JS-CSS",
};
