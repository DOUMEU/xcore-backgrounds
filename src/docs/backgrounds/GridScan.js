...
import componentCode from "../../components/backgrounds/GridScan.jsx?raw";
import cssCode from "../../components/backgrounds/GridScan.css?raw";

const installCommands = {
  pnpm: "pnpm dlx shadcn@latest add @react-bits/GridScan-JS-CSS",
  npm: "npx shadcn@latest add @react-bits/GridScan-JS-CSS",
  yarn: "yarn dlx shadcn@latest add @react-bits/GridScan-JS-CSS",
  bun: "bunx shadcn@latest add @react-bits/GridScan-JS-CSS",
};

const usageCode = `import GridScan from './GridScan';
